...
class FirstViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func buttonGo(_ sender: UIButton) {
        ...
        performSegue(withIdentifier: "showResult", sender: line)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "showResult") {
            ...
            let line = sender as! (CardingMachine, CrossLapper, Drafter, NeedleLoom, Drafter, NeedleLoom)
    ...
    lazy var line : (CardingMachine, CrossLapper, Drafter, NeedleLoom, Drafter, NeedleLoom) = (carding,cross,drafter,needle,drafter2,needle2)
